            ...
            {menuItems
              ...
              .map((item) => (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-2.5 text-sm font-medium transition-all duration-200 hover:opacity-90 rounded-lg ${
                    ...
                    <div className="absolute bottom-full right-0 mb-2 w-72 bg-white border border-gray-200 rounded-xl shadow-lg z-50">
                      <div className="p-4">
                        ...
                        <button
                          ...
                          className={`w-full flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors ${
                            visibility === 'Private (Pro)' ? 'bg-gray-100' : ''
                          }`}
                          style={{
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Store environment variables, API keys, and other sensitive data securely.</p>
                  </div>
                      ...
                      <tr>
                        <td colSpan={4} className="px-6 py-12 text-center">
                          <div className="text-gray-500">
                            ...
                            <p className="text-sm mt-1">Add your first environment variable to get started</p>
                          </div>
                        </td>
                      </tr>
                    </tbody>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Manage API keys for external services.</p>
                  </div>
                  <button className="px-4 py-2 bg-black text-white rounded-lg font-medium hover:bg-gray-800 transition-colors">
                    Add API key
                  </button>
