    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-gray-100 rounded-[20px] p-8 transition-all duration-300"
            style={{
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className="w-full px-4 py-3 bg-gray-100 rounded-[10px] text-gray-700 placeholder-gray-500 outline-none transition-all duration-200 focus:text-gray-900 disabled:opacity-50"
                  style={{
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link to="/forgot-password" className="text-sm font-medium text-gray-600 hover:text-black hover:underline transition-colors">
                    Forgot password?
                  </Link>
                </div>
                <input
              ...
              {message && (
                <div className={`p-3 rounded-lg text-sm ${message.includes('✅') || message.includes('successful') ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}>
                  {message}
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full text-white py-3 font-medium transition-all duration-200 hover:opacity-90 disabled:opacity-50"
                style={{
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center px-4 py-3 bg-gray-100 rounded-[10px] text-gray-700 hover:bg-gray-200 transition-colors disabled:opacity-50"
                  style={{
                    boxShadow: 'rgba(158, 158, 158, 0.69) 0px 0.706592px 0.706592px -0.583333px, rgba(158, 158, 158, 0.68) 0px 1.80656px 1.80656px -1.16667px, rgba(158, 158, 158, 0.65) 0px 3.62176px 3.62176px -1.75px, rgba(158, 158, 158, 0.61) 0px 6.8656px 6.8656px -2.33333px, rgba(158, 158, 158, 0.52) 0px 13.6468px 13.6468px -2.91667px, rgba(158, 158, 158, 0.3) 0px 30px 30px -3.5px, rgb(255, 255, 255) 0px 3px 1px 0px inset'
                  }}>
                  ...
                  <span className="ml-3 text-sm font-medium">Google</span>
                </button>
                <button
