...
export default function SignUp() {
  ...
  const { signUpWithPassword, signInWithGoogle, signInWithGitHub, testConnection } = useAuth();

  const handleSignUp = async (e: React.FormEvent) => {
    e.preventDefault();
    
    console.log('=== SIGN UP ATTEMPT START ===');
    ...
    try {
      console.log('Calling signUpWithPassword...');
      ...
      setLoading(false);
      console.log('=== SIGN UP ATTEMPT END ===');
    }
  };
  ...
  const handleTestConnection = async () => {
    ...
    try {
      ...
      setMessage(isConnected ? '✅ Supabase connection successful!' : '❌ Supabase connection failed');
    } catch (error: any) {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-gray-100 rounded-[20px] p-8 transition-all duration-300"
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              {message && (
                <div className={`p-3 rounded-lg text-sm ${message.includes('✅') ? 'bg-green-50 text-green-700' : message.includes('❌') ? 'bg-red-50 text-red-700' : message.includes('Account created') ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}>
                  {message}
                </div>
              )}
              ...
              <button
                ...
                disabled={loading}
                className="w-full text-gray-700 py-2 font-medium transition-all duration-200 hover:bg-gray-200 disabled:opacity-50 border border-gray-300 rounded-[10px]"
              >
                {loading && message.includes('Testing') ? 'Testing...' : 'Test Supabase Connection'}
              </button>
            </form>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <button 
                  ...
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="#4285F4" d="M22.56 12.25c0-.78-.05-1.21-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
